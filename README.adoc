...
本项目使用 https://v2.vuepress.vuejs.org/zh/[VuePress,window=_blank] 搭建，搭配使用的主题是 https://vuepress-theme-hope.github.io/v2/zh/[VuePress Theme Hope,window=_blank] 

== https://whitechen233.github.io/[笔记首页,window=_blank]