 ...
 */</span>
  ...
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>Tips：此时打包，会发现根目录下的 dist 没有打包出来的文件，而是在 build 文件夹下，这是因为<code>base.config.js</code>中配置的<code>output</code>的<code>path.reslove(__dirname, &#39;dist&#39;)</code>，将<code>&#39;dist&#39;</code>修改为<code>&#39;../dist&#39;</code>即可</p></blockquote>`,37);function m(b,g){const e=t("ExternalLinkIcon");return o(),l("div",null,[r,n("blockquote",null,[u,d,n("p",null,[s("这里有"),n("a",k,[s("官方解释"),i(e)])])]),v])}const w=p(c,[["render",m],["__file","Webpack.html.vue"]]);export{w as default};
