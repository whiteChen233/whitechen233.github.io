...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面的类关系如下图所示：</p><figure><img src="`+c+`" alt="依赖关系的例子" tabindex="0" loading="lazy"><figcaption>依赖关系的例子</figcaption></figure><h4 id="泛化关系" tabindex="-1"><a class="header-anchor" href="#泛化关系" aria-hidden="true">#</a> 泛化关系</h4><p>泛化关系实际上是继承关系，它是依赖关系的特例</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">// BaseDao.java</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面的类关系如下图所示：</p><figure><img src="`+l+`" alt="泛化关系的例子" tabindex="0" loading="lazy"><figcaption>泛化关系的例子</figcaption></figure><h4 id="实现关系" tabindex="-1"><a class="header-anchor" href="#实现关系" aria-hidden="true">#</a> 实现关系</h4><p>实现关系也是依赖关系的特例</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">// PersonService.java</span>
