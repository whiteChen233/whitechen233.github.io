...
![数据库模式-数据库系统结构层次](/assets/note/qccstp/数据库模式-数据库系统结构层次.png)
...
- 部分依赖  
  ...
  ![数据库模式与范式-部分函数依赖](/assets/note/qccstp/数据库模式与范式-部分函数依赖.png)
- 传递依赖  
  关系模式：$R_2(A,B,C)$，依赖集：$\lbrace A \to B, B \to C \rbrace$  
  ![数据库模式与范式-传递函数依赖](/assets/note/qccstp/数据库模式与范式-传递函数依赖.png)
...
![数据库设计-数据库设计步骤](/assets/note/qccstp/数据库设计-数据库设计步骤.png)
...
![分布式数据库-模式架构](/assets/note/qccstp/分布式数据库-DDBMS模式架构.png)
...
![分布式数据库-DDBMS结构](/assets/note/qccstp/分布式数据库-DDBMS结构.png)
