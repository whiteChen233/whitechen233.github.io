...
- `瀑布模型（SDLC）`  
  ...
  ![软件开发方法-瀑布模型](../img/软件开发方法-瀑布模型.png)
- 演化模型
- 增量模型
  
  ![软件开发方法-增量模型](../img/软件开发方法-增量模型.png)
- `螺旋模型`
  - 适合与大型系统，引入了风险分析
  
  ![软件开发方法-螺旋模型](../img/软件开发方法-螺旋模型.png)
- `原型模型`
  - 抛弃型原型（快速原型模型）
  - 进化型模型
- 喷泉模型
...
- V模型
  ...
  ![软件开发方法-V模型](../img/软件开发方法-V模型.png)
- 迭代模型/迭代开发方法
- 快速应用开发（RAD）
  
  ![软件开发方法-快速应用开发](../img/软件开发方法-快速应用开发.png)
- 构建组装模型/基于构件的开发方法（CBSD）
  - 构件库是快的核心
  - 优点：快、节省成本、可靠性高
  
  ![软件开发方法-构件组装模型](../img/软件开发方法-构件组装模型.png)
- `统一过程/统一过程开发（UP/RUP）`
  
  ![软件开发方法-统一过程](../img/软件开发方法-统一过程.png)
- `敏捷开发方法`
  - 小步快跑模式，适合小型项目开发
  - 4大价值观；5大原则；12大最佳实践
  - 开发方法：
    ...
    - SCRUM：`明确定义了可重复的方法过程`，2-4周一个冲刺（发布一个可用版本）
        ...
        ![软件开发方法-Scrum开发模型](../img/软件开发方法-Scrum开发模型.png)
  ...
  ![软件开发方法-敏捷方法](../img/软件开发方法-敏捷方法.png)
- 模型驱动的开发方法
- `基于架构的开发方法`

> 其他经典模型
> 
> ![软件开发方法-其他经典模型](../img/软件开发方法-其他经典模型.png)

### 逆向工程

![软件开发方法-逆向工程](../img/软件开发方法-逆向工程.png)
...
##### 定义需求基线
![需求工程-需求状态](../img/需求工程-需求状态.png)

##### 需求跟踪
![需求工程-需求跟踪](../img/需求工程-需求跟踪.png)
...
- 变更流程
  ...
  ![需求工程-变更流程](../img/需求工程-变更流程.png)

- 工作状态变化
  
  ![需求工程-工作状态](../img/需求工程-工作状态.png)
...
![软件系统建模-内聚类型](../img/软件系统建模-内聚类型.png)

![软件系统建模-耦合类型](../img/软件系统建模-耦合类型.png)
...
#### 基本过程
![软件系统建模-面向对象设计-基本过程](../img/软件系统建模-面向对象设计-基本过程.png)
...
### 遗留系统演化策略
![系统运行与维护-遗留系统演化策略](../img/系统运行与维护-遗留系统演化策略.png)

### 新旧系统的转换策略
![系统运行与维护-新旧系统的转换策略](../img/系统运行与维护-新旧系统的转换策略.png)
...
### 数据转换与迁移
![系统运行与维护-数据转换与迁移](../img/系统运行与维护-数据转换与迁移.png)
