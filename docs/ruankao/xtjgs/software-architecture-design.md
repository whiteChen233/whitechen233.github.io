...
![软件架构-软件架构概念](../img/软件架构-软件架构概念.png)
...
### 软件架构的发展史
![软件架构-软件架构的发展史](../img/软件架构-软件架构的发展史.png)
...
### 数据流风格
![软件架构的风格-数据流风格](../img/软件架构的风格-数据流风格.png)
> 特点：数据处理、严格流程
- 批处理序列
...
### 调用/返回风格
![软件架构的风格-调用/返回风格](../img/软件架构的风格-调用_返回风格.png)
- 主程序/子程序
...
> - `现代集成编译环境一般采用这种架构风格`
> 
>   ![软件架构的风格-编译器区别](../img/软件架构的风格-编译器区别.png)
...
- 黑板系统
  ...
  ![软件架构的风格-黑板系统](../img/软件架构的风格-黑板系统.png)
- 超文本系统
...
- 两层C/S架构
  ...
  ![软件架构的风格-两层CS架构](../img/软件架构的风格-两层CS架构.png)
- 三层C/S架构

  ![软件架构的风格-三层CS架构-1](../img/软件架构的风格-三层CS架构-1.png)

  ![软件架构的风格-三层CS架构-2](../img/软件架构的风格-三层CS架构-2.png)
- 三层B/S架构
  ...
  - B/S架构的数据提交一版以页面为单位，数据的动态交互性不强，不利于OLTP应用
    ...
    ![软件架构的风格-三层BS架构](../img/软件架构的风格-三层BS架构.png)
- 混合架构风格

  ![软件架构的风格-混合架构风格](../img/软件架构的风格-混合架构风格.png)

### 补充
#### 三层B/S架构

![软件架构的风格-三层BS架构-扩展](../img/软件架构的风格-三层BS架构-扩展.png)
...
- MVC架构风格
  ...
  - 可以分为主动MVC和被动MVC两种
    ...
    ![软件架构的风格-两种MVC交互形式](../img/软件架构的风格-两种MVC交互形式.png)
- MVP架构风格
  - MVP是MVC的变种
  ...
  ![软件架构的风格-MVP架构风格](../img/软件架构的风格-MVP架构风格.png)
- MVVM架构风格

  ![软件架构的风格-MVVM架构风格](../img/软件架构的风格-MVVM架构风格.png)
#### 富互联网应用（RIA）
![软件架构的风格-富互联网应用](../img/软件架构的风格-富互联网应用.png)
...
![软件架构的风格-基于服务的架构](../img/软件架构的风格-基于服务的架构.png)
> `服务总线ESB`充当了*中介者*的角色

![软件架构的风格-SOA](../img/软件架构的风格-SOA.png)
- 服务构件粗粒度，传统构件细粒度居多
...
- Web Service
  ...
  ![软件架构的风格-Web Service](../img/软件架构的风格-WebService.png)
  - 底层传输层
  - 服务通信协议层
  - 服务描述层
  - 服务层
...
- ESB
  ...
  ![软件架构的风格-ESB](../img/软件架构的风格-ESB.png)
  - 提供位置透明性的消息路由和寻址服务
  - 提供服务注册和命名的管理功能
  - 支持多种的消息传递范型
  - 支持多种可以广泛使用的传输协议
...
![软件架构的风格-微服务](../img/软件架构的风格-微服务.png)
...
![软件架构的风格-MDA](../img/软件架构的风格-MDA.png)
...
### 基本活动
![特定领域软件架构-DSSA](../img/特定领域软件架构-DSSA.png)

### 领域分析机制
![特定领域软件架构-领域分析机制](../img/特定领域软件架构-领域分析机制.png)
...
### 建立过程
![特定领域软件架构-建立过程](../img/特定领域软件架构-建立过程.png)

### 三层次模型
![特定领域软件架构-三层次模型](../img/特定领域软件架构-三层次模型.png)
...
#### 主要的中间件
![构件与中间件技术-主要的中间件](../img/构件与中间件技术-主要的中间件.png)
- 远程过程调用
- 对象请求代理
- 远程方法调用
- 面向消息的中间件
...
##### Corba（公共对象请求代理体系结构）
![构件与中间件技术-Corba-1](../img/构件与中间件技术-Corba-1.png)
- 伺服对象（Servant）：Corba对象的真正实现，负责完成客户端请求
- 对象适配器（Object Adapter）：用于屏蔽ORB内核的实现细节，服务器对象的实现提供抽象接口，以便他们使用ORB内部的某些功能
- 对象请求代理（Object Request Broker）：解释调用并负责查找实现该请求的对象，将参数传给找到的对象，并调用方法返回结果。客户方不需要了解服务对象的位置、通信方式、实现、激活或存储机制

![构件与中间件技术-Corba-2](../img/构件与中间件技术-Corba-2.png)

![构件与中间件技术-Corba-3](../img/构件与中间件技术-Corba-3.png)

### 典型应用架构 - J2EE
#### 分布式多层应用程序
![典型应用架构-J2EE](../img/典型应用架构-J2EE.png)
...
#### J2EE 核心组成
![典型应用架构-J2EE核心组成](../img/典型应用架构-J2EE核心组成.png)

## Web架构设计
![web架构设计](../img/web架构设计.png)
### 单台机器 到 数据库与Web服务器分离
![Web架构设计-单机到服务分离](../img/Web架构设计-单机到服务分离.png)
### 应用服务器集群
![Web架构设计-应用服务器集群](../img/Web架构设计-应用服务器集群.png)

> 系统演变的过程中，出现了以下问题：
> - 用户请求由谁来转发到具体的应用服务器
> - 用户如果每次访问到的服务器不一样，那么如何维护session的一致性
> 
> ![Web架构设计-维护session的一致性](../img/Web架构设计-维护session的一致性.png)
...
![Web架构设计-数据库读写分离化](../img/Web架构设计-数据库读写分离化.png)

#### 用缓存缓解读库的压力
随着访问量的增大，还是会有瓶颈：磁盘I/O，硬盘的效率瓶颈

![Web架构设计-缓存缓解读库压力](../img/Web架构设计-缓存缓解读库压力.png)
...
>   - 大部分缓存失效 → 数据库奔溃
> 
>   ![Web架构设计-Redis缓存雪崩](../img/Web架构设计-Redis缓存雪崩.png)
>   - 解决方案：
>     - 缓存的高可用性
>     - 缓存降级
>     - Redis备份
...
![Web架构设计-CDN](../img/Web架构设计-CDN.png)
